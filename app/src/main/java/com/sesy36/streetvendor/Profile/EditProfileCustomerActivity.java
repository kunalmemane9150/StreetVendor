...
public class EditProfileCustomerActivity extends AppCompatActivity {
    ...
    private EditText nameEt, emailEt, phoneEt, stateEt, cityEt, addressEt;
        ...
        FirebaseFirestore.getInstance().collection("Users")
                ...
                .addSnapshotListener((value, error) -> {
                    ...
                    if (value.exists()){
                        ...
                        try {
                            Glide.with(EditProfileCustomerActivity.this)
                                    .load(profileURL)
    ...
    private String name , email, phone, state, city, address;
        ...
        if (image_uri == null){
            ...
            FirebaseFirestore.getInstance()
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            ...
                            Toast.makeText(EditProfileCustomerActivity.this, "Profile updated", Toast.LENGTH_SHORT).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            progressBar.setVisibility(View.GONE);
                            Toast.makeText(EditProfileCustomerActivity.this, "Failed to update profile", Toast.LENGTH_SHORT).show();
                        }
                    });
            ...
            user.updateEmail(email)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void unused) {
                            Toast.makeText(EditProfileCustomerActivity.this, "Email is updated", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(EditProfileCustomerActivity.this, "Use your old email to sign in" + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
            ...
            storageReference.putFile(image_uri)
                    .addOnCompleteListener(task -> {
                        ...
                        if (task.isSuccessful()) {
                                        ...
                                        FirebaseFirestore.getInstance().collection("Users")
                                                ...
                                                .update(map).addOnCompleteListener(task1 -> {
                                                    ...
                                                    if (task1.isSuccessful()) {
                                                        progressBar.setVisibility(View.GONE);
                                                        Toast.makeText(EditProfileCustomerActivity.this, "Updated Successfully...", Toast.LENGTH_SHORT).show();
                                                    } else {
                                                        assert task1.getException() != null;
                                                        progressBar.setVisibility(View.GONE);
                                                        Toast.makeText(EditProfileCustomerActivity.this, "Error: " + task1.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                                    }
                            ...
                            progressBar.setVisibility(View.GONE);
                            Toast.makeText(EditProfileCustomerActivity.this, "Error: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
